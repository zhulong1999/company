...
class Index extends  Controller
{
    ...
    public function  index()
    {
        ...
        $where_qiye_jianjie['parentid'] =1;
        $qiye_jianjie = Db::name('article')->where($where_qiye_jianjie)->field('aid,title,content')->order('sortd','desc')->limit(5)->select();
        $this->assign('qiye_jianjie',$qiye_jianjie);
        //精品展示
        $where_jingping_zhanshi['isdelete'] = 1;
        $where_jingping_zhanshi['typeid'] = 5;
        ...
        $where_hangye_dongtai['parentid'] = 6;
        $hangye_dongtai = Db::name('article')->where($where_hangye_dongtai)->order('sortd','desc')->field('aid,title,pubtime,typeid')->select();
    ...
    public function about()
    {
        ...
        if (empty($aid)){
            ...
            $article = Db::name('article')->where("isdelete = 1 and aid=$aid")->order('sortd','desc')->find();
        }
